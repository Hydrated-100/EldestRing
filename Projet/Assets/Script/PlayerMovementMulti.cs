...
public class PlayerMovementMulti : Entity
    {
        ...
        private bool CheckGameOver()
        {
            ...
            GameManagementMulti.instance.GameOver();
            return true;
        ...
        private void Restart()
        {
            ...
            GameManagementMulti.instance.levelClear();
        }
        ...
        void Update()
        {
            ...
            if (photonView.IsMine )
            {
                ...
                {
                    Console.WriteLine("Nothing ahead");
                }

                if (Input.GetButtonDown(KeyCode.Delete.ToString()))
                {
                    try
                    {
                        Vector2 start = transform.position;
                        ...
                        var classHit = hit.transform.GetComponent<Entity>();
                        if (classHit is Entity)
                        {
                            cantMove(classHit);
                        }
                    }
